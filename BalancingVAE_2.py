...
class BalancingVAE(nn.Module):
    ...
    def __init__(self,
        ...
        self.name = f'BVAE2_MLP{hidden_dims[0]}_{in_channels}_{latent_dim}'
    ...
    def loss_function(self, 
        ...
        kl_loss = torch.mean(-0.5 * torch.sum(1 + log_var - mu ** 2 - log_var.exp(), dim = 1)) * self.gamma**2
        ...
        gen_loss = F.mse_loss(recons, input)
